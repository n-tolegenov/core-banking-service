...
public abstract class BaseMapper<E, D> {
    /*
        Object... args
        Синтаксис "..." указывает на то, что метод может принимать произвольное количество аргументов данного типа.
        Внутри метода args будет представлен как массив объектов типа Object, содержащий переданные аргументы.
        Это позволяет создавать более гибкие методы, которые могут принимать разное количество аргументов.
     */
